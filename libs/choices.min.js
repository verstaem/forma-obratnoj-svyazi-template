...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(t)
      : ((e =
          "undefined" != typeof globalThis ? globalThis : e || self).Choices =
          t());
})(this, function () {
  "use strict";
  var e = function (t, i) {
  ...
  var s,
    ...
    T = function (e, t) {
      return {
        ...
        labelDescription: L(e.labelDescription),
    ...
    N = function (e, t, i) {
      return "function" == typeof e ? e(A(t), L(t), i) : e;
    },
    k = function (e, t) {
      return e ? M(t) : A(t);
    },
    ...
    R = function (e, t) {
      var i;
      (i = e.classList).add.apply(i, P(t));
    },
    K = function (e, t) {
      var i;
      (i = e.classList).remove.apply(i, P(t));
    },
    V = function (e) {
      if (void 0 !== e)
        try {
    ...
    B = (function () {
      ...
      return (
        (e.prototype.show = function () {
          return (
            R(this.element, this.classNames.activeState),
        ...
        (e.prototype.hide = function () {
          return (
            K(this.element, this.classNames.activeState),
    ...
    H = (function () {
      ...
      return (
        ...
        (e.prototype.open = function (e, t) {
          (R(this.element, this.classNames.openState),
            this.element.setAttribute("aria-expanded", "true"),
            (this.isOpen = !0),
            this.shouldFlip(e, t) &&
              (R(this.element, this.classNames.flippedState),
              (this.isFlipped = !0)));
        }),
        (e.prototype.close = function () {
          (K(this.element, this.classNames.openState),
            this.element.setAttribute("aria-expanded", "false"),
            this.removeActiveDescendant(),
            (this.isOpen = !1),
            this.isFlipped &&
              (K(this.element, this.classNames.flippedState),
              (this.isFlipped = !1)));
        }),
        (e.prototype.addFocusState = function () {
          R(this.element, this.classNames.focusState);
        }),
        (e.prototype.removeFocusState = function () {
          K(this.element, this.classNames.focusState);
        }),
        (e.prototype.addInvalidState = function () {
          R(this.element, this.classNames.invalidState);
        }),
        (e.prototype.removeInvalidState = function () {
          K(this.element, this.classNames.invalidState);
        }),
        (e.prototype.enable = function () {
          (K(this.element, this.classNames.disabledState),
            this.element.removeAttribute("aria-disabled"),
            this.type === _ && this.element.setAttribute("tabindex", "0"),
            (this.isDisabled = !1));
        }),
        (e.prototype.disable = function () {
          (R(this.element, this.classNames.disabledState),
        ...
        (e.prototype.addLoadingState = function () {
          (R(this.element, this.classNames.loadingState),
            this.element.setAttribute("aria-busy", "true"),
            (this.isLoading = !0));
        }),
        (e.prototype.removeLoadingState = function () {
          (K(this.element, this.classNames.loadingState),
        ...
        (e.prototype.setWidth = function () {
          ...
          if (t || i) {
            ...
            ((o.style.position = "absolute"),
              ...
              R(o, Array.from(e.classList)),
              e.after(o));
            var r = parseFloat(getComputedStyle(o).width);
            (Number.isNaN(r)
              ? ((n = i.length), (s = t.length))
              : (i &&
                  ((o.innerText = i),
                  (n = parseFloat(getComputedStyle(o).width) / r)),
                t &&
                  ((o.innerText = t),
                  (s = parseFloat(getComputedStyle(o).width) / r))),
              o.remove());
          }
          ((e.style.minWidth = "".concat(Math.ceil(n) + 1, "ch")),
            (e.style.width = "".concat(Math.ceil(s) + 1, "ch")));
        }),
        (e.prototype.setActiveDescendant = function (e) {
          this.element.setAttribute("aria-activedescendant", e);
        }),
    ...
    W = (function () {
      ...
      return (
        ...
        (e.prototype.conceal = function () {
          var e = this.element;
          (R(e, this.classNames.input), (e.hidden = !0), (e.tabIndex = -1));
    ...
    J = function (e, t, i) {
      ...
      return {
        ...
        active: G(c.active),
        selected: G(c.selected, !1),
        disabled: G(c.disabled, !1),
        placeholder: G(c.placeholder, !1),
        highlighted: !1,
        labelClass: z(c.labelClass),
              ...
              (e.setAttribute("value", ""), (e.value = "")),
            {
              ...
              labelClass:
                void 0 !== e.dataset.labelClass
                  ? z(e.dataset.labelClass)
                  : void 0,
              labelDescription:
                void 0 !== e.dataset.labelDescription
                  ? { trusted: e.dataset.labelDescription }
                  : void 0,
              customProperties: V(e.dataset.customProperties),
            }
          );
        }),
    ...
    Y = {
      ...
      removeItemLabelText: function (e, t, i) {
        return "Remove item: ".concat(i ? A(i.label) : e);
      },
    ...
    te = (function () {
      ...
      return (
        ...
        (e.prototype.dispatch = function (e) {
          ...
          (Object.keys(ee).forEach(function (o) {
            var r = ee[o](i[o], e, t._context);
  ...
  const me = (e) => `Missing ${e} property in key`,
    ve = (e) => `Property 'weight' in key '${e}' must be a positive integer`,
  ...
  function ye(e) {
    let t = null,
      ...
      s = 1,
      o = null;
    if (he(e) || ae(e)) ((n = e), (t = be(e)), (i = Ee(e)));
    else {
      if (!ge.call(e, "name")) throw new Error(me("name"));
      const r = e.name;
      if (((n = r), ge.call(e, "weight") && ((s = e.weight), s <= 0)))
        throw new Error(ve(r));
      ((t = be(r)), (i = Ee(r)), (o = e.getFn));
    }
  ...
  const Se = {
    ...
    getFn: function (e, t) {
      ...
      return (s(e, he(t) ? t.split(".") : t, 0), n ? i : i[0]);
    },
    ignoreLocation: !1,
    ignoreFieldNorm: !1,
    fieldNormWeight: 1,
  ...
  class Ie {
    ...
    add(e) {
      const t = this.size();
      he(e) ? this._addString(e, t) : this._addObject(e, t);
    }
    removeAt(e) {
  ...
  function Ae(
    e,
    t,
    { getFn: i = Ce.getFn, fieldNormWeight: n = Ce.fieldNormWeight } = {},
  ) {
    const s = new Ie({ getFn: i, fieldNormWeight: n });
    return (s.setKeys(e.map(ye)), s.setSources(t), s.create(), s);
  }
  function xe(
    e,
    {
      ...
      distance: s = Ce.distance,
      ignoreLocation: o = Ce.ignoreLocation,
    } = {},
  ) {
    const r = t / e.length;
    if (o) return r;
  ...
  class Me {
    constructor(
      e,
      {
        location: t = Ce.location,
        threshold: i = Ce.threshold,
        distance: n = Ce.distance,
        includeMatches: s = Ce.includeMatches,
        findAllMatches: o = Ce.findAllMatches,
        minMatchCharLength: r = Ce.minMatchCharLength,
        isCaseSensitive: c = Ce.isCaseSensitive,
        ignoreLocation: a = Ce.ignoreLocation,
      } = {},
    ) {
      if (
        ((this.options = {
        ...
        return;
      const h = (e, t) => {
          this.chunks.push({ pattern: e, alphabet: Le(e), startIndex: t });
        },
      ...
      if (l > Oe) {
        ...
        const t = l % Oe,
          i = l - t;
        for (; e < i; ) (h(this.pattern.substr(e, Oe), e), (e += Oe));
        if (t) {
          const e = l - Oe;
      ...
      this.chunks.forEach(({ pattern: t, alphabet: d, startIndex: p }) => {
        const {
          ...
          i,
          {
            ...
            distance: s = Ce.distance,
            threshold: o = Ce.threshold,
            findAllMatches: r = Ce.findAllMatches,
            minMatchCharLength: c = Ce.minMatchCharLength,
            includeMatches: a = Ce.includeMatches,
          ...
          const S = { isMatch: f >= 0, score: Math.max(0.001, y) };
          if (m) {
            const e = (function (e = [], t = Ce.minMatchCharLength) {
              let i = [],
                n = -1,
                s = -1,
                o = 0;
            ...
            e.length ? a && (S.indices = e) : (S.isMatch = !1);
          }
          return S;
        })(e, t, d, {
          location: n + p,
  ...
  const Ke = [];
  function Ve(e, t) {
    for (let i = 0, n = Ke.length; i < n; i += 1) {
      let n = Ke[i];
  ...
  const Be = "$and",
    He = "$path",
    qe = (e) => !(!e[Be] && !e.$or),
    $e = (e) => ({ [Be]: Object.keys(e).map((t) => ({ [t]: e[t] })) });
  function We(e, t, { auto: i = !0 } = {}) {
    const n = (e) => {
      let s = Object.keys(e);
      const o = ((e) => !!e[He])(e);
      if (!o && s.length > 1 && !qe(e)) return n($e(e));
      if (((e) => !ae(e) && ue(e) && !qe(e))(e)) {
        const n = o ? e[He] : s[0],
          r = o ? e.$val : e[n];
        if (!he(r)) throw new Error(((e) => `Invalid value for key ${e}`)(n));
        const c = { keyId: Ee(n), pattern: r };
        return (i && (c.searcher = Ve(r, t)), c);
      }
  ...
  function Ue(e, t) {
    ...
    ((t.matches = []),
      de(i) &&
        i.forEach((e) => {
          if (!de(e.indices) || !e.indices.length) return;
  ...
  class ze {
    constructor(e, t = {}, i) {
      ((this.options = ce(ce({}, Ce), t)),
        (this._keyStore = new _e(this.options.keys)),
    ...
    setCollection(e, t) {
      ...
      this._myIndex =
        t ||
        Ae(this.options.keys, this._docs, {
    ...
    search(e, { limit: t = -1 } = {}) {
      ...
      return (
        (function (e, { ignoreFieldNorm: t = Ce.ignoreFieldNorm }) {
          e.forEach((e) => {
            let i = 1;
        ...
        s && c.sort(o),
        le(t) && t > -1 && (c = c.slice(0, t)),
        (function (
          e,
          t,
          {
            includeMatches: i = Ce.includeMatches,
            includeScore: n = Ce.includeScore,
          } = {},
        ) {
          const s = [];
          return (
  ...
  ((ze.version = "7.0.0"),
    (ze.createIndex = Ae),
    (ze.parseIndex = function (
      e,
      { getFn: t = Ce.getFn, fieldNormWeight: i = Ce.fieldNormWeight } = {},
    ) {
      const { keys: n, records: s } = e,
        o = new Ie({ getFn: t, fieldNormWeight: i });
    ...
    (function (...e) {
      ...
      class {
        constructor(
          e,
          {
            isCaseSensitive: t = Ce.isCaseSensitive,
            includeMatches: i = Ce.includeMatches,
            minMatchCharLength: n = Ce.minMatchCharLength,
            ignoreLocation: s = Ce.ignoreLocation,
            findAllMatches: o = Ce.findAllMatches,
            location: r = Ce.location,
            threshold: c = Ce.threshold,
            distance: a = Ce.distance,
          } = {},
        ) {
          ((this.query = null),
            (this.options = {
  ...
  var Je = (function () {
      ...
      return (
        ...
        (e.prototype.search = function (e) {
          return (
            this._fuse ||
              (this._fuse = new ze(this._haystack, this._fuseOptions)),
    ...
    Xe = function (e, t, i) {
      ...
      (o && (n.labelClass = P(o).join(" ")),
        r && (n.labelDescription = L(r)),
        i &&
          s &&
          ("string" == typeof s
    ...
    Ye = {
        ...
        return (
          ...
          i &&
            ...
            s
              ...
              : r || Qe(this._docRoot, this.passedElement.element.id, a),
      ...
      item: function (e, t, i) {
        ...
        if ((R(f, a), t.labelClass)) {
          var m = document.createElement("span");
          (D(m, n, t.label), R(m, t.labelClass), f.appendChild(m));
        } else D(f, n, t.label);
        if (
          ((f.dataset.item = ""),
          (f.dataset.id = t.id),
          ...
          t.placeholder && (R(f, d), (f.dataset.placeholder = "")),
          R(f, t.highlighted ? l : u),
          i)
        ) {
          (t.disabled && K(f, u), (f.dataset.deletable = ""));
          ...
          (_ && v.setAttribute("aria-label", _),
            (v.dataset.button = ""),
            s ? f.insertAdjacentElement("afterbegin", v) : f.appendChild(v));
        }
        return f;
      },
      ...
      choiceGroup: function (e, t) {
        ...
        return (R(d, o), D(d, i, a || ""), u.appendChild(d), u);
      },
      choice: function (e, t, i, n) {
        ...
        ((m.id = t.elementId),
          ...
          n &&
            "string" == typeof p &&
            ((p = k(s, p)), (p = { trusted: (p += " (".concat(n, ")")) })));
        var v = m;
        if (t.labelClass) {
          var g = document.createElement("span");
          (D(g, s, p), R(g, t.labelClass), (v = g), m.appendChild(g));
        } else D(m, s, p);
        if (t.labelDescription) {
          var _ = "".concat(t.elementId, "-description");
          v.setAttribute("aria-describedby", _);
          var y = document.createElement("span");
          (D(y, s, t.labelDescription), (y.id = _), R(y, u), m.appendChild(y));
        }
        return (
          t.selected && R(m, h),
          t.placeholder && R(m, d),
          ...
          t.disabled
            ...
            : (R(m, a),
              ...
              m.setAttribute("aria-selected", t.selected ? "true" : "false")),
          m
        );
      },
      input: function (e, t) {
        ...
        return (
          ...
          t
            ...
            : o || Qe(this._docRoot, this.passedElement.element.id, r),
          r
        );
      },
      dropdown: function (e) {
        var t = e.classNames,
          ...
          n = t.listDropdown,
          s = document.createElement("div");
        return (R(s, i), R(s, n), s.setAttribute("aria-expanded", "false"), s);
      },
      notice: function (e, t, i) {
        ...
        switch ((D(l, !0, t), R(l, s), R(l, o), R(l, h), i)) {
          case se:
            R(l, r);
            break;
          case ne:
  ...
  return (function () {
    function e(t, n) {
      ...
      if (!a || "object" != typeof a || ("INPUT" !== a.tagName && !X(a))) {
      ...
      if (
        ((this.passedElement = this._isTextElement
          ? new U({ element: a, classNames: r.classNames })
          : new Q({
              element: a,
        ...
        (this.initialised = !1),
        (this._store = new te(r)),
        (this._currentValue = ""),
        (r.searchEnabled = !l && r.searchEnabled),
    ...
    return (
      ...
      (e.prototype.init = function () {
        if (!this.initialised && void 0 === this.initialisedOK) {
          ((this._searcher = new Je(this.config)),
            this._loadChoices(),
      ...
      (e.prototype.highlightItem = function (e, t) {
        ...
        return (
          !i ||
            ...
            t && this.passedElement.triggerEvent(v, T(i))),
          this
        );
      }),
      (e.prototype.unhighlightItem = function (e, t) {
        ...
        return i && i.highlighted
          ? (this._store.dispatch(C(i, !1)),
            t && this.passedElement.triggerEvent("unhighlightItem", T(i)),
            this)
          : this;
      }),
          ...
          this._store.withTxn(function () {
            e._store.items.forEach(function (t) {
              t.highlighted ||
                ...
                e.passedElement.triggerEvent(v, T(t)));
            });
          }),
          this
        );
          ...
          this.dropdown.isActive ||
            ...
            requestAnimationFrame(function () {
              ...
              var n = t.choiceList.element.querySelector(
                j(t.config.classNames.selectedState),
              );
              null === n ||
                I(n, t.choiceList.element) ||
          ...
          this._isSelectElement
            ? (this._store.withTxn(function () {
                ...
                (i ||
                  ...
                  n.clearStore(!1));
                var r = function (e) {
                  i ? n._store.dispatch(S(e)) : o[e.value] && (e.selected = !0);
                };
      ...
      (e.prototype.removeChoice = function (e) {
        ...
        return t
          ? (this._clearNotice(),
            ...
            this._searcher.reset(),
            t.selected && this.passedElement.triggerEvent(m, T(t)),
            this)
          : this;
      }),
      ...
      (e.prototype._renderChoices = function () {
        ...
        if (this._canAddItems()) {
          var t = this.config,
            ...
            s = n.activeGroups,
            o = n.activeChoices,
            r = i ? t.searchResultLimit : t.renderChoiceLimit;
          if (this._isSelectElement) {
            ...
            h = function (e) {
              return e.filter(function (e) {
                return (
                  !e.placeholder &&
                  (i
                    ? (t.searchRenderSelectedChoices || !e.selected) && !!e.rank
                    : t.renderSelectedChoices || !e.selected)
                );
              });
            },
            l = t.appendGroupInSearch && i,
            u = !1,
            d = null,
            p = function (n, s) {
              i ? n.sort(F) : t.shouldSort && n.sort(t.sorter);
              var o = n.length;
              ((o = !s && r > 0 && o > r ? r : o),
                o--,
                n.every(function (n, s) {
                  var r =
                    ...
                    e._templates.choice(
                      ...
                      n,
                      t.itemSelectText,
                      l && n.group ? n.group.label : void 0,
                    );
                  return (
                    (n.choiceEl = r),
                    a.appendChild(r),
                    i || !n.selected ? (u = !0) : d || (d = r),
                    s < o
                  );
                }));
            };
              ...
              ? (t.shouldSort && s.sort(t.sorter),
                ...
                s.forEach(function (t) {
                  ...
                  if (i.length) {
                    if (t.label) {
                      var n =
                        t.groupEl || e._templates.choiceGroup(e.config, t);
                      ((t.groupEl = n), n.remove(), a.appendChild(n));
                    }
                    p(i, !0);
                  }
                }))
      ...
      (e.prototype._renderItems = function () {
        ...
        if (this._isSelectOneElement) {
          ...
          if (c || a > 1) {
            var h = i.querySelector(j(n.classNames.placeholder));
            h && h.remove();
          } else
            c ||
              a ||
      ...
      (e.prototype._clearNotice = function () {
        if (this._notice) {
          var e = this.choiceList.element.querySelector(
            j(this.config.classNames.notice),
          );
        ...
        if (this._isTextElement) {
          if (
            ...
            var n = this.passedElement.value
              .split(i.delimiter)
              .map(function (e) {
                return J(e, !1, t.config.allowHtmlUserInput);
              });
      ...
      (e.prototype._canAddItems = function () {
        ...
        return !e.singleModeForMultiSelect &&
          ...
          ? (this.choiceList.element.replaceChildren(""),
            (this._notice = void 0),
            this._displayNotice("function" == typeof i ? i(t) : i, se, !1),
            !1)
          : (this._notice && this._notice.type === se && this._clearNotice(),
            !0);
      }),
      (e.prototype._canCreateItem = function (e) {
        ...
        if (
          (i &&
            ...
            !t.addItemFilter(e) &&
            ((i = !1), (n = N(t.customAddItemText, e, void 0))),
          i &&
            this._store.choices.find(function (i) {
              return t.valueComparer(i.value, e);
            }))
        ) {
          if (this._isSelectElement) return (this._displayNotice("", se), !1);
          t.duplicateItemsAllowed ||
            ((i = !1), (n = N(t.uniqueItemText, e, void 0)));
        }
        return (
          i && (n = N(t.addItemText, e, void 0)),
          n && this._displayNotice(n, se),
          i
        );
      }),
      (e.prototype._searchChoices = function (e) {
        ...
        return (
          (s && s.type) !== se &&
            (n.length
              ? this._clearNotice()
              : this._displayNotice(O(this.config.noResultsText), ne)),
          this._store.dispatch(
            (function (e) {
      ...
      (e.prototype._onEnterKey = function (e, t) {
        ...
        if ((e.preventDefault(), s && s.hasAttribute("data-button")))
          ...
          var o = this.dropdown.element.querySelector(
            j(this.config.classNames.highlightedState),
          );
              ...
              if (this._canAddItems()) {
                ...
                (this._store.withTxn(function () {
                  if (!(r = i._findAndSelectChoiceByValue(n, !0))) {
                    ...
                    (i._addChoice(
                      J(n, !1, i.config.allowHtmlUserInput),
                      !0,
                      !0,
                    ),
                      (r = !0));
      ...
      (e.prototype._onDirectionKey = function (e, t) {
        ...
        if (t || this._isSelectOneElement) {
          ...
          var n = 40 === i || 34 === i ? 1 : -1,
            s = void 0;
          if (e.metaKey || 34 === i || 33 === i)
            s = this.dropdown.element.querySelector(
              n > 0 ? "".concat(it, ":last-of-type") : it,
            );
          else {
            var o = this.dropdown.element.querySelector(
              j(this.config.classNames.highlightedState),
            ...
            s = o
              ...
              : this.dropdown.element.querySelector(it);
          }
          (s &&
            (I(s, this.choiceList.element, n) ||
              this.choiceList.scrollToChildElement(s, n),
            this._highlightChoice(s)),
            e.preventDefault());
        }
      }),
      ...
      (e.prototype._onMouseDown = function (e) {
        ...
        if (t instanceof Element) {
          if (Ze && this.choiceList.element.contains(t)) {
      ...
      (e.prototype._removeHighlightedChoices = function () {
        ...
        Array.from(this.dropdown.element.querySelectorAll(j(e))).forEach(
          function (t) {
            (K(t, e), t.setAttribute("aria-selected", "false"));
          },
        );
      }),
      (e.prototype._highlightChoice = function (e) {
        void 0 === e && (e = null);
        var t = Array.from(this.dropdown.element.querySelectorAll(it));
        if (t.length) {
          var i = e,
      ...
      (e.prototype._addItem = function (e, t, i) {
        ...
        if (
          ...
          var n = T(e);
          (this.passedElement.triggerEvent("addItem", n),
            i && this.passedElement.triggerEvent("choice", n));
        }
      }),
      (e.prototype._removeItem = function (e) {
        if (e.id) {
          this._store.dispatch(S(e));
          var t = this._notice;
          (t && t.type === ie && this._clearNotice(),
            this.passedElement.triggerEvent(m, T(e)));
        }
      }),
      ...
      (e.prototype._createTemplates = function () {
        var e = this,
          ...
          i = {};
        "function" == typeof t && (i = t.call(this, x, k, P));
        var n = {};
      ...
      (e.prototype._createElements = function () {
        ...
        ((this.containerOuter = new H({
          ...
          (this.choiceList = new $({ element: e.choiceList(t, i) })),
          (this.itemList = new $({ element: e.itemList(t, i) })),
          (this.dropdown = new B({
